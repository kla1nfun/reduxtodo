      ...
      <div className={styles.home}>
        ...
        <div className="container">
          ...
          <dl>
            ...
            <dt>Cool TodoList</dt>
            <dd>
              The <Link to="/todo-list">TodoList</Link> is a small app where you can tap and save all of your tasks,
              watch their conditions and mark what you have done as complited.
            </dd>
